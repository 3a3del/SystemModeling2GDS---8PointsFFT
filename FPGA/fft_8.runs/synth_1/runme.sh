...
HD_PWD='/home/ICer/viv/fft_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_8point_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_8point_top.tcl
